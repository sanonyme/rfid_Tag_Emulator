      ...
      main: {
        ...
        vite: {
          ...
          build: {
            ...
            rollupOptions: {
              external: ['electron', 'electron-updater', 'node-pty', 'mysql2', 'mysql2/promise', 'pg', 'ssh2', 'basic-ftp', '@mimasu/tdt', '@aws-sdk/client-s3', '@aws-sdk/lib-storage', '@aws-sdk/client-sts'],
            },
          },
        },
      },
